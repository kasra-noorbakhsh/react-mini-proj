    ...
    return (
        <form onSubmit={submit} className="stock-filter-form">
            ...
            <div style={{ height: "10px" }}>
                <label>نماد: </label>
                <input className="stock-filter-form-input" type="text" placeholder="نماد..." name={FieldNamesEnum.symbol}
            ...
            <div>
                ...
                <input className="stock-filter-form-input" type="text" placeholder="نام شرکت..." name={FieldNamesEnum.companyName}
                    onChange={onChangeProcess} onBlur={onBlurProcess} />
            </div>

            <div>
                <label>حوزه صنعتی: </label>
                <input className="stock-filter-form-input" type="text" placeholder="حوزه صنعتی..." name={FieldNamesEnum.industry}
                    onChange={onChangeProcess} onBlur={onBlurProcess} />
            </div>

            <div>
                <label>حداکثر قیمت خرید: </label>
                <input className="stock-filter-form-input" type="text" placeholder="حداکثر قیمت خرید..." name={FieldNamesEnum.maxPrice}
                    onChange={onChangeProcess} onBlur={onBlurProcess} onKeyDown={blockNonNumericOnKeyDown} />
            </div>

            <div>
                <label>حداقل قیمت خرید: </label>
                <input className="stock-filter-form-input" type="text" placeholder="حداقل قیمت خرید..." name={FieldNamesEnum.minPrice}
                    onChange={onChangeProcess} onBlur={onBlurProcess} onKeyDown={blockNonNumericOnKeyDown} />

    ...
    return(
        <form onSubmit={submit} className="stock-filter-form">
            ...
            <div>
                ...
                <input className="stock-filter-form-input" type="text" placeholder="نام شرکت..." name={FieldNamesEnum.companyName} onChange={onChangeProcess} onBlur={onBlurProcess}/>
            </div>
            <div>
                <label>حوزه صنعتی: </label>
                <input className="stock-filter-form-input" type="text" placeholder="حوزه صنعتی..." name={FieldNamesEnum.industry} onChange={onChangeProcess} onBlur={onBlurProcess}/>
            </div>
            <div>
                <label>حداکثر قیمت خرید: </label>
                <input className="stock-filter-form-input" type="text" placeholder="حداکثر قیمت خرید..." name={FieldNamesEnum.maxPrice} onChange={onChangeProcess} onBlur={onBlurProcess} onKeyDown={blockNonNumericOnKeyDown}/>
            </div>
            <div>
